...
${OBJECTDIR}/funcoesBadData.o: funcoesBadData.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/funcoesBadData.o funcoesBadData.c
...
${OBJECTDIR}/funcoesOtimizacao.o: funcoesOtimizacao.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/funcoesOtimizacao.o funcoesOtimizacao.c
...
${OBJECTDIR}/funcoesWLS.o: funcoesWLS.c 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.c) -g -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/funcoesWLS.o funcoesWLS.c
